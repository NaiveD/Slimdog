...
def function_discrete(x1, x2, x3, x4, x5):
    ...
    # para_space = list(np.arange(-20, 21, 40/10)) # S1
    # para_space = list(np.arange(-20, 21, 40/100)) # S2
    # para_space = list(np.arange(-20, 21, 40/1000)) # S3
    # para_space = list(np.arange(-20, 21, 40/10000)) # S4
    para_space = list(np.arange(-20, 21, 40/100000)) # S5
