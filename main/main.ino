...
void loop() {
  ...
  delay(400);
  set_leg(x, y, z + lift, 0); // RF
  set_leg(x, y, z + lift, 2); // LB
  ...
  delay(400);
  set_leg(x, y, z + lift, 1); // LF
  set_leg(x, y, z + lift, 3); // RB
...
float set_leg(float x, float y, float z, int leg) {
  ...
  if (leg == 0) { // Right Front   
    ...
    pwm.setPWM(0+1, 0, angletoPWM(angle1)); // Yellow
    pwm.setPWM(0+2, 0, angletoPWM(angle2)); // Orange
    pwm.setPWM(0, 0, angletoPWM(angle3)); // Green
  }
    ...
    pwm.setPWM(8+1, 0, angletoPWM(angle1)); // Yellow
    pwm.setPWM(8+2, 0, angletoPWM(angle2)); // Orange
    pwm.setPWM(8, 0, angletoPWM(angle3)); // Green
  }
    ...
    pwm.setPWM(12+1, 0, angletoPWM(angle1)); // Yellow
    pwm.setPWM(12+2, 0, angletoPWM(angle2)); // Orange
    pwm.setPWM(12, 0, angletoPWM(angle3)); // Green
  }
    ...
    pwm.setPWM(4+1, 0, angletoPWM(angle1)); // Yellow
    pwm.setPWM(4+2, 0, angletoPWM(angle2)); // Orange
    pwm.setPWM(4, 0, angletoPWM(angle3)); // Green
  }
}
